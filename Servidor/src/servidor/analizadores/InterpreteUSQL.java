...
public class InterpreteUSQL implements Constantes{
    ...
    public static String interpretarSentenciasUsql(int codigo, Nodo lsent, String cadUsql) throws IOException{
        String response = "";
    ...
    public static String interpretarSentenciaUsql(int codigo, Nodo sent, String cadUsql) throws IOException{
        String result;
