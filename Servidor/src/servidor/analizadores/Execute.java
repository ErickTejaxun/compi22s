...
import servidol.server.manejador.Atributo;
...
public class Execute {
    ...
    private Simbolo declararVar(Nodo root, String ambito, int caso) throws IOException {//0 global // 1 local
        Simbolo result = null;
        switch (root.token) {
            case "INST":
            case "DEC": {
...
//                System.out.println("Declaracion " + key);
    ...
    @SuppressWarnings("UnusedAssignment")
    public Simbolo Expre(Nodo expr) throws IOException {
    ...
    @SuppressWarnings("UnusedAssignment")
    private Simbolo getValue(Nodo expr) throws IOException {//H
        ...
        switch (expr.token) {
            ...
            case "CONTAR": {//cuenta
                valor.tipe = "integer";
                int count = EjecucionUSQL.select(expr.getHijo(0)).size();
                valor.value = count + "";
                break;
            }
    ...
    protected Simbolo callMetodo(Nodo root, Simbolo valor, int opcion) throws IOException {
    ...
    private void tipoParametro2(Nodo root, ArrayList<Simbolo> paramet, int i, int caso) throws IOException {
    ...
    public void initExecute(String idMetodo) throws IOException {
    ...
    private boolean accion(Nodo root) {
     ...
     String tipocase="";
     String valcase="";
    protected Simbolo executeCode(Nodo root) throws IOException {
        Simbolo RESULT = null;
        if (root == null) {
            return null;
        }
...
//                        "<b>" + root.token + "</b>" + texto));
    ...
    public Simbolo addmetodounico(Metodo met) {
