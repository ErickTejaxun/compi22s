...
public class BBDD {
    ...
    public Metodo getMetodo(String idDB, String idMet) {
        return this.bbdd.get(idDB).metodos.getMetodo(idMet);
    }
    ...
    public String getArbol() {
        ...
        for(BD bd : this.bbdd.values()){
            if(bd.permissonsDB.existe(Server.user))
                arbol += bd.getArbol() + ",";
        }
...
class BD{
    ...
    String getArbol() {
        ...
        arbol += "            \"nombre\": \"" + this.idDB + "\",\n";
        arbol += this.tablas.getArbol();
        arbol += this.metodos.getArbol();
        arbol += this.objetos.getArbol();
