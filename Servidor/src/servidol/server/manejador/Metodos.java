...
public class Metodos {
    ...
    Metodo getMetodo(String idMet) {
        return this.metodos.get(idMet);
    }
    ...
    public String getArbol(){
        ...
        for(String m : this.metodos.keySet())
            if(this.metodos.get(m).permissions.existe(Server.user))
                arbol += "            \"funcion\": \"" + m + "\",\n";
        return arbol;
    }
...
//        }
//        try {
//            new Grafica().graficar(lpar, "/home/erick/Desktop/ASTs/usql/metodos/parametros_" + this.idMethod);
...
//        
//        try {
//            new Grafica().graficar(nodo, "/home/erick/Desktop/ASTs/usql/metodos/sentencias_" + this.idMethod);
//        } catch (IOException ex) {
//            Logger.getLogger(Metodo.class.getName()).log(Level.SEVERE, null, ex);
//        }
//        
